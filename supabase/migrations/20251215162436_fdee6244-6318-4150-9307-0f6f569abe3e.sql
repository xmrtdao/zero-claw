-- Fix util.invoke_edge to disable statement_timeout during execution
-- This prevents pg_cron's 2-minute statement_timeout from killing pg_sleep calls
...
BEGIN
  -- CRITICAL: Disable statement timeout for this function's execution
  -- This prevents pg_cron's 2-minute timeout from killing our pg_sleep polling
